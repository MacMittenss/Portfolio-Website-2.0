            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                {["HTML", "CSS", "SASS", "Tailwind", "JavaScript", "TypeScript", "React", "Express.js", "Vite"].map((tech, index) => (
                  <div
                    key={tech}
                    className={`flex flex-col items-center justify-center p-4 rounded-lg bg-card/10 border border-slate-300 dark:border-slate-300 hover:border-slate-400 dark:hover:border-slate-200 transition-all duration-300 min-h-[120px] md:bg-transparent md:border-none md:p-2 md:min-h-[80px] ${
                  ...
                  >
                    <div className="text-3xl md:text-5xl mb-3 flex items-center justify-center">
                      ...
                      {tech === "Vite" && <Zap className="text-purple-500" />}
